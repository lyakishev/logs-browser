...
class TreeViewColumnExample:
    ...
    def __init__(self):
        ...
        # the background
        self.liststore.append(['Open', gtk.STOCK_OPEN, 'Open a File', "#0000FF"])
        self.liststore.append(['New', gtk.STOCK_NEW, 'New File', "#00FF00"])
        self.liststore.append(['Print', gtk.STOCK_PRINT, 'Print File', "#FF0000"])
        ...
        if gtk.gtk_version[1] < 2:
            self.tvcolumn.set_cell_data_func(self.cellpb, self.make_pb,cell_background=3)
        else:
            self.tvcolumn.set_attributes(self.cellpb, stock_id=1,cell_background=3)
        self.tvcolumn.set_attributes(self.cell, text=0, cell_background=3)
